...
Route::middleware(['checkLogin'])->group(function () {
    ...
    Route::get('/export-search-camp', [ReportController::class, 'exportSearchCamp']);
    Route::get('/export-page1-camp', [ReportController::class, 'exportPage1Camp']);
    Route::get('/export-adsense-search', [ReportController::class, 'exportAbsenseSearch']);
    Route::get('/export-reports', [ReportController::class, 'exportReports']);
    Route::get('/export-links', [ReportController::class, 'exportLinks']);
