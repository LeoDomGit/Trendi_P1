...
function SearchCamp({ data }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post('/search_camp_import', formData, {
        headers: {
  ...
  const columns = [
    ...
    { field: "click_page_search", headerName: "Click Page Search", flex: 1 },
    { field: "cost_search", headerName: "Cost Search", flex: 1 },
